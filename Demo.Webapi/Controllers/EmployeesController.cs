    ...
    public class EmployeesController : BaseController<Employee>
    {
        ...
        public IActionResult Excel([FromQuery] string title)
        {
            ...
            using (var package = new ExcelPackage(stream))
            {
                ...
                int i = 4;
                var datas = _employeeBL.GetRecords();
                foreach (var data in datas)
                {
                    ...
                    foreach (var prop in properties)
                    {
                        ...
                        switch (j)
                        {
                            case 1:
                                {
                                    workSheet.Cells[i, j].Value = data.employeeid;
                                    break;
                                }
                            case 2:
                                {
                                    workSheet.Cells[i, j].Value = data.employeecode;
                                    break;
                                }
                            case 3:
                                {
                                    workSheet.Cells[i, j].Value = data.fullname;
                                    break;
                                }
                            case 4:
                                {
                                    workSheet.Cells[i, j].Value = data.phonenumber;
                                    break;
                                }
                            case 5:
                                {
                                    workSheet.Cells[i, j].Value = data.email;
                                    break;
                                }
                            case 6:
                                {
                                    workSheet.Cells[i, j].Value = data.gender;
                                    break;
                                }
                            case 7:
                                {
                                    workSheet.Cells[i, j].Value = data.dateofbirth;
                                    break;
                                }
                            case 8:
                                {
                                    workSheet.Cells[i, j].Value = data.createdat;
                                    break;
                                }
                            case 9:
                                {
                                    workSheet.Cells[i, j].Value = data.createdby;
                                    break;
                                }
                            case 10:
                                {
                                    workSheet.Cells[i, j].Value = data.modifiedat;
                                    break;
                                }
                            case 11:
                                {
                                    workSheet.Cells[i, j].Value = data.modifiedby;
                                    break;
                                }
                            default:
                                {
